                                ...
                                <DropdownMenuContent className="w-56">
                                    <DropdownMenuItem asChild>
                                        <Link to="/browse?category=fiction">
                                            Fiction
                                            <DropdownMenuShortcut><img src={fictionImg} width="25px" /></DropdownMenuShortcut>
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/browse?category=non-fiction">
                                            Non-Fiction
                                            <DropdownMenuShortcut><img src={nonFictionBook} width="25px" /></DropdownMenuShortcut>
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/browse?category=science">
                                            Science
                                            <DropdownMenuShortcut><img src={scienceBook} width="25px" /></DropdownMenuShortcut>
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/browse?category=history">
                                            History
                                            <DropdownMenuShortcut><img src={historyBook} width="25px" /></DropdownMenuShortcut>
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/browse?category=technology">
                                            Technology
                                            <DropdownMenuShortcut><img src={technologyBook} width="25px" /></DropdownMenuShortcut>
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/browse">
                                            See All
                                            <DropdownMenuShortcut><img src={seeAll} width="25px" /></DropdownMenuShortcut>
                                        </Link>
                                    </DropdownMenuItem>
                                </DropdownMenuContent>
                            </DropdownMenu>
